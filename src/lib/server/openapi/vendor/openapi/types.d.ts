 ...
 */
export type AnySchema<TInput = unknown, TOutput = unknown> = BaseSchema<TInput, TOutput, BaseIssue<unknown>> | BaseSchemaAsync<TInput, TOutput, BaseIssue<unknown>>;
/**
 ...
 */
export interface EndpointDef<TQuerySchema extends AnySchema | undefined = AnySchema | undefined, TBodySchema extends AnySchema | undefined = AnySchema | undefined, TResponses extends EndpointResponses = EndpointResponses> {
    /**
   * Valibot schema describing the request body.
   *
 ...
 */
export type EndpointResponses<TSchemaMap extends Record<PropertyKey, AnySchema | undefined> = Record<number, AnySchema | undefined>> = {
    [Status in keyof TSchemaMap]: ResponseDef<Extract<TSchemaMap[Status], AnySchema | undefined>>;
};
/**
 ...
 * };
 */
export type MultiEndpointModule<TEndpoint extends EndpointDef = EndpointDef> = {
 ...
 * }
 */
export type PathsObject = Record<string, Partial<Record<HttpMethodLower, OperationObject>>>;
/**
 ...
 */
export interface ResponseDef<TSchema extends AnySchema | undefined = AnySchema | undefined> {
    /**
