import type { AnySchema, EndpointDef, EndpointResponses, HttpMethod, ResponseDef } from './types.ts';
 ...
 *
 */
export declare const defineEndpoint: <TQuerySchema extends AnySchema | undefined = AnySchema | undefined, TBodySchema extends AnySchema | undefined = AnySchema | undefined, TResponseSchemas extends Record<number, AnySchema | undefined> = Record<number, AnySchema | undefined>>(def: EndpointDef<TQuerySchema, TBodySchema, EndpointResponses<TResponseSchemas>>) => EndpointDef<TQuerySchema, TBodySchema, EndpointResponses<TResponseSchemas>>;
